...
export async function POST(request: Request){
    try {
        ...
        const {username, password, first_name, last_name, email, phone_number} = await request.json()
        //validate email and password here
        console.log({username, password, first_name, last_name, email, phone_number})
        try {
