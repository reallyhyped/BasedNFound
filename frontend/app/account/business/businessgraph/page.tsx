...
Chart.register(LineController, CategoryScale, LinearScale, PointElement, LineElement, TimeScale, TimeSeriesScale);
...
const BusinessGraph = () => {
    ...
    //sort data by date
    const sampleData = unsortedSampleData.sort((a, b) => new Date(a.date) - new Date(b.date));
