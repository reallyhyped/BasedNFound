...
const LostPage = () => {
  ...
  if (searchInput.trim() === "") {
    ...
    // If search input is not empty, filter items based on the search input and "lost" status
  ...
  const lostItemsToShow = filteredItems.length > 0 ? filteredItems : lostItems;
