...
const ReportLost = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            console.error('Error submitting claim, log, item, or contain:', error.message);
            setError(error.message);
        }
    };
        ...
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            <div className="flex flex-col w-full p-8 space-y-4 items-center bg-white sm:w-96 rounded-xl shadow-lg">
                ...
                <form onSubmit={handleSubmit}>
                    <textarea className="w-full px-4 py-2 rounded-lg mb-4" name="itemName" placeholder="Name" required></textarea>
